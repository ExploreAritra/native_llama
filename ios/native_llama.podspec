Pod::Spec.new do |s|
  ...
  s.source_files = [
    ...
    'shared_cpp_copy/tools/mtmd/**/*.{h,cpp,c}'
  ]

  # Exclude ALL standalone CLI and Debug tools to prevent duplicate main() symbols
  s.exclude_files = [
    'shared_cpp_copy/tools/mtmd/mtmd-cli.cpp',
    'shared_cpp_copy/tools/mtmd/debug/mtmd-debug.cpp'
  ]
  ...
  # --- FIXED: Aggressively force compiler to ignore Apple Audio frameworks ---
  ...
  s.pod_target_xcconfig = {
    ...
    'HEADER_SEARCH_PATHS' => [
      ...
      '"$(PODS_TARGET_SRCROOT)/shared_cpp_copy/tools/mtmd"',
