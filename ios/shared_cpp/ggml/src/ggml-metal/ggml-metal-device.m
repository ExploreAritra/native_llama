...
ggml_metal_cv_t ggml_metal_cv_init(void) {
    ggml_metal_cv_t res =  (ggml_metal_cv_t)calloc(1, sizeof(struct ggml_metal_cv));
...
ggml_metal_pipeline_t ggml_metal_pipeline_init(void) {
    ggml_metal_pipeline_t res =  (ggml_metal_pipeline_t)calloc(1, sizeof(struct ggml_metal_pipeline));
...
ggml_metal_library_t ggml_metal_library_init(ggml_metal_device_t dev) {
    ...
    // TODO: move to a function
    {
     ...
     ggml_metal_library_t res = (ggml_metal_library_t)calloc(1, sizeof(struct ggml_metal_library));
...
ggml_metal_encoder_t ggml_metal_encoder_init(ggml_metal_cmd_buf_t cmd_buf_raw, bool concurrent) {
     ggml_metal_encoder_t res = (ggml_metal_encoder_t)calloc(1, sizeof(struct ggml_metal_encoder));
...
ggml_metal_rsets_t ggml_metal_rsets_init(void) {
     ggml_metal_rsets_t res = (ggml_metal_rsets_t)calloc(1, sizeof(struct ggml_metal_rsets));
...
ggml_metal_device_t ggml_metal_device_init(int device) {
     ggml_metal_device_t dev = (ggml_metal_device_t)calloc(1, sizeof(struct ggml_metal_device));
...
ggml_metal_buffer_t ggml_metal_buffer_init(ggml_metal_device_t dev, size_t size, bool shared) {
     ggml_metal_buffer_t res = (ggml_metal_buffer_t)calloc(1, sizeof(struct ggml_metal_buffer));
